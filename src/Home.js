...
export const Home = () => {
    ...
    //solution of javascript is in public folder i am export x variable here we can import it and do condition operation
                                ...
                                <div className="row">
                                                            ...
                                                            <div className="product-o product-o--hover-on product-o--radius">
                                                                <div className="product-o__wrap box-img">
                                                                    <a className="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                                        ...
                                                                        <img className='imgsetbox1 ' src={`data:image/png;base64,${e.photo}`}/>
                                                                    </a>
                                                                ...
                                                                <span className="product-o__price">Rs. {e.price}
                                    ...
                                    <div className="col-lg-12">
                                        <div className="load-more">
                                            <Link className="btn btn--e-brand custom_btn " to={'/newarrival'}>Load More</Link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
